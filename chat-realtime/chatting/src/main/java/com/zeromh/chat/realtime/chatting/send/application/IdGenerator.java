...
public class IdGenerator {
    ...
    private static final AtomicLong serialNum = new AtomicLong(1);


    // Generate Next Id (SerialNum 동시성 처리 문제만 확인하면)
    public static long generateNewId(long serverId, long dataCenterId) {
        ...
        if(timestamp == oldTimestamp) {
            ...
            serialNum.set(serialNum.addAndGet(1) & serialMask);
